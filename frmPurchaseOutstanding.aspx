<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Master.Master" CodeBehind="frmPurchaseOutstanding.aspx.cs" Inherits="New_Project.Master.frmPurchaseOutstanding" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <i class="bi bi-file-earmark-spreadsheet"></i> Export
                ...
                <div class="mt-3 text-end">
                    <span class="fw-bold" style="font-size: 21px">Total Outstanding Purchase : </span>
