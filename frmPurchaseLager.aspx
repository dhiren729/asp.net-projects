<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Master.Master" CodeBehind="frmPurchaseLager.aspx.cs" Inherits="New_Project.Master.frmPurchaseLager" %>
   ...
   <i class="bi bi-file-earmark-spreadsheet"></i> Export
                ...
                <asp:GridView ID="grvStock" runat="server" CssClass="table table-hovers table-bordered table-striped" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundField DataField="final_Amount" HeaderText="final Amount " />
                    </Columns>
                </asp:GridView>
                <div class="mt-3 text-end">
                    <span class="fw-bold" style="font-size: 21px">Total Final Amount : </span>
