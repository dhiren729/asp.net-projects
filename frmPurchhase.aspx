<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Master.Master" CodeBehind="frmPurchhase.aspx.cs" Inherits="New_Project.Master.frmPurchhase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body style="background-color: rgb(188,206,230)">
        ...
        <form id="form1" style="background-color: rgb(188.206.230)">
            <div class="container mt-4" id="Penal2" runat="server" style="background-color: rgb(188,206,230)">
             ...
             <%--   <div class="mt-3 text-end">
                    <span class="fw-bold">Total Final Amount: </span>
